  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        ...
        <span className="block truncate text-[10px] font-medium text-slate-400">{department}</span>
      </span>
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="min-w-0 flex-1">
            <span className="flex items-center gap-1">
              ...
              {role.is_system ? (
                <Lock className="h-2.5 w-2.5 shrink-0 text-slate-400" aria-label="System role" />
              ) : null}
            </span>
        ...
        <div className="ml-auto flex flex-wrap items-center gap-2">
          <div className="relative">
            ...
            <input
              ...
              className="w-52 rounded-lg border border-slate-200 py-1.5 pl-9 pr-8 text-xs text-slate-800 placeholder:text-slate-400 focus:border-blue-400 focus:outline-none"
            />
            {query ? (
              <button
                type="button"
            ...
            <table className="w-full text-left text-sm">
              <thead className="sticky top-0 z-10 bg-white shadow-[0_1px_0_0_theme(colors.slate.200)]">
                <tr>
                  ...
                  <th scope="col" className="border-b border-slate-200 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.12em] text-slate-400">
                    Person
                  </th>
                  <th scope="col" className="border-b border-slate-200 px-3 py-2 text-[10px] font-bold uppercase tracking-[0.12em] text-slate-400">
                    Department
                      ...
                      <tr>
                        <td colSpan={4} className="border-b border-slate-200 bg-slate-50 px-3 py-1.5">
                          <span className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-[0.12em] text-slate-500">
                            ...
                            />
                            {role.name}
                            <span className="tabular-nums text-slate-400">{members.length}</span>
                          </span>
                        </td>
                      </tr>
                      {members.map((member) => {
