...
export const SETTINGS_TABS: SettingsTabDef[] = [
  ...
  },
  {
    ...
    group: 'workspace',
    icon: CalendarRange,
    keywords: 'leave holiday annual quota accrual pro rate joining cutoff carry forward encash probation sick casual earned balance ledger',
  },
  {
    id: 'legal-entities',
    name: 'Legal entities',
  ...
  },
  {
    ...
    group: 'workspace',
    icon: Fingerprint,
    keywords: 'biometric device punch fingerprint face attendance machine essl zkteco matrix adms terminal serial swipe card reader enrol enroll clock in',
  },
  {
    id: 'single-sign-on',
    name: 'Single sign-on',
    group: 'workspace',
    icon: KeyRound,
    keywords: 'sso saml single sign on entra azure ad okta onelogin google workspace identity provider idp federation certificate metadata acs entity id provisioning login',
  },
  {
    id: 'organization',
    name: 'Organization',
