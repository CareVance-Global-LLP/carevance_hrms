...
export const topNavigation: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      // /breaks is a PERSONAL break tracker — start/end your own break. Admins
      // do not punch a clock, so showing it to them was just the employee page
      // in the admin panel. Admin-side break visibility lives where it belongs:
      // the break-time column in Attendance, the Break Time card in Employee
      // Detail, and break type configuration in Settings > Organization.
