  ...
  return (
    <div className="space-y-4">
      ...
      {summary ? (
        ...
        <p className="text-xs text-slate-500">Large CSV and XLSX uploads are sent in batches. Department names or IDs in the departments column apply per row. Separate multiple departments or projects with | or ;.</p>
      )}
    </div>
  );
}
