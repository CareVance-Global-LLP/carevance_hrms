              ...
              <tr>
                ...
                {columns.map((col) => (
                  <th key={col.key} className="border-b border-slate-200 bg-slate-50 px-4 py-3.5 text-center">
                    ...
                    <p className="text-[10px] font-medium text-slate-500 mt-0.5">{col.sublabel}</p>
                  </th>
                ))}
              </tr>
            </thead>
                ...
                return [
                  <tr key={`header-${section.category}`}>
                    <td
                      ...
                      className="bg-gradient-to-r from-slate-50 to-transparent px-4 py-2.5 text-[11px] font-bold uppercase tracking-[0.18em] text-slate-500"
                    >
                      {section.category}
                    </td>
                  </tr>,
